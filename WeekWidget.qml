...
GridLayout {
    ...
    Component.onCompleted: {
        m_modelMediator.slotInfo("objId:"+objId+
                                 "     week:"+ week+
                                 "     maxValue:"+ maxValue+
                                 "     line1From:" + line1From +
                                 "     line1To:"+ line1To+
                                 "     line2MWFrom:"+ line2MWFrom+
                                 "     line2MWTo:"+ line2MWTo+
                                 "     line2MarsFrom:"+ line2MarsFrom+
                                 "     line2MarsTo:"+ line2MarsTo+
                                 "     line2CrispFrom:"+line2CrispFrom+
                                 "     line2CrispTo:"+ line2CrispTo+
                                 "     line3MWFrom:"+line3MWFrom+
                                 "     line3MWTo:"+line3MWTo+
                                 "     line3MarsFrom:"+line3MarsFrom+
                                 "     line3MarsTo:"+line3MarsTo+
                                 "     line3SNKFrom:"+line3SNKFrom+
                                 "     line3SNKTo:"+line3SNKTo+
                                 "      complited. ");
    }
...
//            modelMediator.setFi(objId)
    ...
    CustomRangeSlider{
        ...
        first.onMoved: {
            parent.setVal()
//            modelMediator.setFi(objId)
            m_modelMediator.setLineValueByName(objId, "Line2MWFrom" ,first.value);
        }
        second.onMoved: {
    ...
    CustomRangeSlider {
        ...
        first.onMoved: {
            parent.setVal()
//            modelMediator.setFi(objId)
            m_modelMediator.setLineValueByName(objId, "Line2MarsFrom" ,first.value);
        }
        second.onMoved: {
            m_modelMediator.setLineValueByName(objId, "Line2MarsTo", second.value);
        }
    }
    ...
    CustomRangeSlider {
        ...
        first.onMoved: {
            parent.setVal()
//            modelMediator.setFi(objId)
            m_modelMediator.setLineValueByName(objId, "Line2CrispFrom" ,first.value);
        }
        second.onMoved: {
            m_modelMediator.setLineValueByName(objId, "Line2CrispTo", second.value);
        }
    }
    ...
    CustomRangeSlider {
        ...
        first.onMoved: {
            parent.setVal()
//            modelMediator.setFi(objId)
            m_modelMediator.setLineValueByName(objId, "Line3MWFrom" ,first.value);
        }
        second.onMoved: {
    ...
    CustomRangeSlider {
        ...
        first.onMoved: {
            parent.setVal()
//            modelMediator.setFi(objId)
            m_modelMediator.setLineValueByName(objId, "Line3MarsFrom" ,first.value);
        }
        second.onMoved: {
            m_modelMediator.setLineValueByName(objId, "Line3MarsTo", second.value);
        }
    }
    ...
    CustomRangeSlider {
        ...
        first.onMoved: {
            parent.setVal()
//            modelMediator.setFi(objId)
            m_modelMediator.setLineValueByName(objId, "Line3SNKFrom" ,first.value);
        }
        second.onMoved: {
            m_modelMediator.setLineValueByName(objId, "Line3SNKTo", second.value);
        }
    }
